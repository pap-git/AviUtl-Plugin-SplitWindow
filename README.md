...
![AviUtl showing the error that "LogicalToPhysicalPointForPerMonitorDPI" is not found from USER32.dll](aviutl_entrypoint.png)

↑のエラーを消してがんばってWindows8.0以前でも使えるようにしよう<br>
<br>
ってわけ<br>
だけどどうなるかはわからないので期待しないでください　CPPのCの文字すらわからないので
